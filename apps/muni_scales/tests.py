...
class CaclulationTestCase(TestCase):
    ...
    def test_xc_results(self):
        ...
        self.assertEqual(xc_result['max_difficulty']['value'], xc.maximum_difficulty)
        self.assertEqual(xc_result['max_difficulty']['result'], 2)
        
        self.assertEqual(xc_result['avg_difficulty']['value'], xc.average_difficulty)
        self.assertEqual(xc_result['avg_difficulty']['result'], 1.5)
        
        self.assertEqual(xc_result['total_score'], 24, "Got an unexpected result for the XC track")